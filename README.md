...
- The bottom overlay states that viewers must have been active in chat during the last five minutes.
- Before a roll, the left avatar automatically loads the `KICK_CHANNEL` profile picture.
